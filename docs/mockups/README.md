# FactoryOS V3 — UI mockup (onaylı)

**Durum:** Kabul edildi — FactoryOS V3 merkezi görsel referans (19.05.2026).

Tarayıcıda doğrudan açılabilir statik HTML önizlemeleri. Gate 1 `@factoryos/ui` implementasyonu bu dosyalara göre yapılır.
...
Spec: [`../v3-spec/00-ui-design-direction-freeze.md`](../v3-spec/00-ui-design-direction-freeze.md) (FROZEN).
